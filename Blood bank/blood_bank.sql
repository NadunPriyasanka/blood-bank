...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2023 at 07:33 PM
...
(1, 1, 5, 'abc', '2023-08-31 16:23:18', '2');
...
(2, 'nadun', 'nadun', '1234', 'cc@gmail.com', 23, 'B+', 123456789, 'abc.123');
...
(3, 'aaa', 'h1', '1234', 'aa@gmail.com', 55887795, 'asd,,d');
...
(1, 1, 'abc', 'efg', 'efg', 25, 'A+', 5, '1'),
(2, 3, 'ere', 'we', 'ew', 50, 'AB+', 56, '1'),
(3, 3, 'ere', 'we', 'ew', 50, 'AB+', 56, '1');
...
--
ALTER TABLE `patient`
  MODIFY `paitent_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
